                    ...
                    <div class="overflow-hidden">
                        ...
                        @else
                            <div class="px-6 py-12 flex flex-col items-center justify-center text-center">
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">{{ __('filament-data-copilot::messages.The intelligent analysis returned no records for this request.') }}</p>
                            </div>
                        @endif
                    </div>
                @endif
